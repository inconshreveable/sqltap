...
class QueryStats(object):
    ...
    :attr start_time: Start time of the query (from py:func:`time.time`)
    :attr end_time: End time of the query (from py:func:`time.time`)
    :attr user_context: The value returned by the user_context_fn set
        with :func:`sqltap.start`.
    :attr params_dict: a dict of the parameters passed to this query
    :attr results: :class:`sqlalchemy.engine.ResultProxy`
